...
//                <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center font-bold text-white shadow-lg">S</div>
//                <span className="text-xl font-bold tracking-tight text-slate-200">Shakkti<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">AI</span></span>
//             </div>
//           </Link>
  ...
  return (
    <div className="bg-slate-900 border border-white/10 rounded-3xl p-10">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <ScoreCircle obtained={score} total={100} size="sm" />
      </div>
      ...
      <div className="min-h-screen bg-slate-950 text-white px-8 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-slate-400 text-sm">
            तुमच्या सर्व चाचण्यांचे सखोल विश्लेषण आणि करिअर तयारी स्कोअर येथे पहा.
          </p>
        </div>
        ...
        <AnimatePresence>
          {selectedReport && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-black/80 backdrop-blur flex justify-center items-center p-6 z-50"
              onClick={() => setSelectedReport(null)}
            >
              <motion.div
                initial={{ scale: 0.95 }}
                animate={{ scale: 1 }}
                exit={{ scale: 0.95 }}
                className="bg-slate-950 w-full max-w-6xl max-h-[90vh] overflow-y-auto rounded-3xl p-12 border border-white/10"
                onClick={(e) => e.stopPropagation()}
              >
                {/* TOP HEADER */}
                <div className="flex justify-between items-center mb-16">
                  <div>
                    <h2 className="text-3xl font-black tracking-wide">
                      {selectedReport.technicalAssessment?.subject}
                    </h2>
                  ...
                  <ScoreCircle
                    obtained={selectedReport.aiReport?.overallScore}
                    total={100}
                    size="sm"
                  />
                </div>
                ...
                <div className="space-y-20">
                  ...
                  <SectionCard
                    ...
                    score={selectedReport.voiceInterview?.percentage}
                    markdown={selectedReport.aiReport?.communicationReport}
                    accent="text-purple-400"
                  />

                  <SectionCard
                    title="सिच्युएशन असेसमेंट"
                    score={selectedReport.situationAssessment?.percentage}
                  ...
                  {/* <div className="bg-gradient-to-r from-indigo-600/10 to-purple-600/10 border border-white/10 rounded-3xl p-12">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <ReactMarkdown>
                        {selectedReport.aiReport?.overallSummary}
                      </ReactMarkdown>
                    </div>
                  </div> */}
